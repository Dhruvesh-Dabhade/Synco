 ...
 *
 * Full-screen Three.js generative terrain background.
 * Solid (wireframe: false), Perlin-noise displaced PlaneGeometry.
 * Point light follows mouse for interactive lighting.
 * Intended as an absolute-positioned backdrop behind page content.
 */
